...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { code: @coupon.code, discount: @coupon.discount, expire_date: @coupon.expire_date } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { code: @coupon.code, discount: @coupon.discount, expire_date: @coupon.expire_date } }
